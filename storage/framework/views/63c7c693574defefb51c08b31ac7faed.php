...
<?php $__env->startSection('title', 'Movies - Nazaarabox'); ?>
...
<?php endif; ?>
    ...
    ?>
        ...
        <article class="group relative bg-white overflow-hidden cursor-pointer dark:!bg-bg-card transition-all duration-300">
            <a href="<?php echo e(route('movies.show', $movie['id'])); ?>" class="block">
                ...
                <div class="relative overflow-hidden w-full aspect-video bg-gray-200 dark:bg-gray-800" style="background-color: transparent !important;">
                        ...
                        <?php
                            ...
                            if ($imagePath) {
                                ...
                                if (str_starts_with($imagePath, 'http')) {
                                    ...
                                    $imageUrl = $imagePath;
                                } elseif (in_array($contentType, ['tmdb', 'article']) || str_starts_with($imagePath, '/')) {
                    ...
                    <?php else: ?>
                        <?php
                            ...
                            $imagePath = $backdropPath ?? $posterPath;
                        ?>
                        <img src="<?php echo e(app(\App\Services\TmdbService::class)->getImageUrl($imagePath, 'w780')); ?>" 
        ...
        <a href="<?php echo e(route('movies.index', ['page' => $currentPage - 1])); ?>" 
        ...
        <a href="<?php echo e(route('movies.index', ['page' => $i])); ?>" 
            ...
            <div class="bg-white border border-gray-200 p-6 dark:!bg-bg-card dark:!border-border-secondary">
                ...
                <div class="space-y-4">
                    <?php if(!empty($popularMovies)): ?>
                        ...
                        <?php
                            $movieId = $movie->slug ?? ('custom_' . $movie->id);
                        ...
                        ?>
                        <a href="<?php echo e(route('movies.show', $movieId)); ?>" class="flex gap-3 group hover:bg-gray-50 p-2 rounded-lg transition-all dark:!hover:bg-bg-card-hover">
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php else: ?>
                        <p class="text-gray-600 text-sm dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">No popular movies available.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox\resources\views/movies/index.blade.php ENDPATH**/ ?>