...
<?php $__env->startSection('title', 'Admin - Comments Management'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
            ...
            <div class="text-2xl font-bold text-gray-900 dark:!text-white mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($stats['total'])); ?></div>
        </div>
        <div class="bg-yellow-50 dark:!bg-yellow-900/20 rounded-lg border border-yellow-200 dark:!border-yellow-800 p-4">
            ...
            <div class="text-2xl font-bold text-yellow-800 dark:!text-yellow-300 mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($stats['pending'])); ?></div>
        </div>
        <div class="bg-green-50 dark:!bg-green-900/20 rounded-lg border border-green-200 dark:!border-green-800 p-4">
            ...
            <div class="text-2xl font-bold text-green-800 dark:!text-green-300 mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($stats['approved'])); ?></div>
        </div>
        <div class="bg-red-50 dark:!bg-red-900/20 rounded-lg border border-red-200 dark:!border-red-800 p-4">
            ...
            <div class="text-2xl font-bold text-red-800 dark:!text-red-300 mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($stats['rejected'])); ?></div>
        </div>
        <div class="bg-gray-50 dark:!bg-gray-900/20 rounded-lg border border-gray-200 dark:!border-gray-800 p-4">
            ...
            <div class="text-2xl font-bold text-gray-800 dark:!text-gray-300 mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($stats['spam'])); ?></div>
        </div>
    </div>

    <!-- Filters -->
    <div class="mb-6 bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
        <form method="GET" action="<?php echo e(route('admin.comments.index')); ?>" class="flex flex-wrap gap-4 items-end">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" value="<?php echo e($filters['search'] ?? ''); ?>" placeholder="Search by name, email, or comment..." 
            ...
            <div class="min-w-[150px]">
                ...
                <select name="status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                    ...
                    <option value="spam" <?php echo e(($filters['status'] ?? '') === 'spam' ? 'selected' : ''); ?>>Spam</option>
                </select>
            </div>
            <div class="min-w-[200px]">
                ...
                <select name="content_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                    ...
                    <?php $__currentLoopData = $contents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($content->id); ?>" <?php echo e(($filters['content_id'] ?? '') == $content->id ? 'selected' : ''); ?>><?php echo e($content->title); ?></option>
            ...
            <div class="min-w-[150px]">
                ...
                <select name="sort_by" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                    <option value="created_at" <?php echo e(($filters['sort_by'] ?? 'created_at') === 'created_at' ? 'selected' : ''); ?>>Date</option>
                    <option value="name" <?php echo e(($filters['sort_by'] ?? '') === 'name' ? 'selected' : ''); ?>>Name</option>
                    <option value="likes" <?php echo e(($filters['sort_by'] ?? '') === 'likes' ? 'selected' : ''); ?>>Likes</option>
                </select>
            </div>
            <div class="min-w-[120px]">
                ...
                <select name="sort_order" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                    <option value="desc" <?php echo e(($filters['sort_order'] ?? 'desc') === 'desc' ? 'selected' : ''); ?>>Desc</option>
                    <option value="asc" <?php echo e(($filters['sort_order'] ?? '') === 'asc' ? 'selected' : ''); ?>>Asc</option>
                </select>
            </div>
            <div>
    ...
    <!-- Bulk Actions -->
    <form id="bulkActionForm" method="POST" action="<?php echo e(route('admin.comments.bulk-action')); ?>" class="mb-4">
        <?php echo csrf_field(); ?>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200 dark:!divide-border-secondary">
                    ...
                    <tr class="hover:bg-gray-50 dark:!hover:bg-bg-card-hover <?php echo e($comment->status === 'pending' ? 'bg-yellow-50/50 dark:!bg-yellow-900/10' : ''); ?>">
                        <td class="px-6 py-4 whitespace-nowrap">
                            <input type="checkbox" name="comment_ids[]" value="<?php echo e($comment->id); ?>" class="comment-checkbox rounded border-gray-300 text-accent focus:ring-accent">
                        </td>
                        <td class="px-6 py-4">
                            <div class="max-w-md">
                        ...
                        <td class="px-6 py-4">
                            <?php if($comment->content): ?>
                                <a href="<?php echo e(route('admin.contents.show', $comment->content)); ?>" class="text-sm text-accent hover:underline" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                                    <?php echo e(Str::limit($comment->content->title, 30)); ?>
                        ...
                        <td class="px-6 py-4">
                            ...
                            ?>
                            <span class="px-2 py-1 rounded text-xs font-semibold <?php echo e($statusColors[$comment->status] ?? 'bg-gray-100 text-gray-800'); ?>" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:!text-text-tertiary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                            <?php echo e($comment->created_at->format('M d, Y')); ?><br>
                            <span class="text-xs"><?php echo e($comment->created_at->format('h:i A')); ?></span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-2">
                                <a href="<?php echo e(route('admin.comments.show', $comment)); ?>" class="text-blue-600 hover:text-blue-800 dark:!text-blue-400 dark:!hover:text-blue-300" title="View">
                                ...
                                <form method="POST" action="<?php echo e(route('admin.comments.approve', $comment)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form method="POST" action="<?php echo e(route('admin.comments.reject', $comment)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <form method="POST" action="<?php echo e(route('admin.comments.spam', $comment)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
                                ...
                                <?php endif; ?>
                                <form method="POST" action="<?php echo e(route('admin.comments.pin', $comment)); ?>" class="inline">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit" class="text-purple-600 hover:text-purple-800 dark:!text-purple-400 dark:!hover:text-purple-300" title="<?php echo e($comment->is_pinned ? 'Unpin' : 'Pin'); ?>">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"></path>
                                        </svg>
                                    </button>
                                </form>
                                <form method="POST" action="<?php echo e(route('admin.comments.destroy', $comment)); ?>" class="inline" onsubmit="return confirm('Are you sure you want to delete this comment?');">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox\resources\views/admin/comments/index.blade.php ENDPATH**/ ?>