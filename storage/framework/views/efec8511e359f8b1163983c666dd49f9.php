...
<?php $__env->startSection('title', 'How to Download - Nazaarabox'); ?>
            ...
            <section class="space-y-6">
                <div class="border-l-4 border-accent pl-6">
                    ...
                    <p class="text-gray-700 dark:!text-text-secondary leading-relaxed" style="font-weight: 400;">
                        Navigate to the <a href="<?php echo e(route('movies.index')); ?>" class="text-accent hover:text-accent-light underline" style="font-weight: 600;">Movies</a> or <a href="<?php echo e(route('tv-shows.index')); ?>" class="text-accent hover:text-accent-light underline" style="font-weight: 600;">TV Shows</a> section to find the content you want to download.
                    </p>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox\resources\views/pages/how-to-download.blade.php ENDPATH**/ ?>