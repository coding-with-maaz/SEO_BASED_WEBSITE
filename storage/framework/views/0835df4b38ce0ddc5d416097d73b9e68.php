...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:!text-white mt-2" style="font-family: 'Poppins', sans-serif; font-weight: 700;">
                        <?php echo e(number_format($totalContent)); ?>
        ...
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:!text-white mt-2" style="font-family: 'Poppins', sans-serif; font-weight: 700;">
                        <?php echo e(number_format($totalMovies)); ?>
        ...
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:!text-white mt-2" style="font-family: 'Poppins', sans-serif; font-weight: 700;">
                        <?php echo e(number_format($totalTvShows)); ?>
            ...
            <div class="mt-4 flex items-center text-sm">
                <span class="text-gray-600 dark:!text-text-secondary font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                    <?php echo e(number_format($totalEpisodes)); ?> Episodes
                </span>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
            ...
            <p class="text-2xl font-bold text-green-600 dark:!text-green-400" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($publishedContent)); ?></p>
        </div>

        <!-- Draft Content -->
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
            <p class="text-sm text-gray-600 dark:!text-text-secondary mb-1" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Draft</p>
            <p class="text-2xl font-bold text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($draftContent)); ?></p>
        </div>
        ...
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
            ...
            <p class="text-2xl font-bold text-yellow-600 dark:!text-yellow-400" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($featuredContent)); ?></p>
        </div>
        ...
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
            ...
            <p class="text-2xl font-bold text-blue-600 dark:!text-blue-400" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($thisMonthContent)); ?></p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2 bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
            <div class="flex items-center justify-between mb-6">
                ...
                <a href="<?php echo e(route('admin.contents.index')); ?>" class="text-sm text-accent hover:underline font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                    View All →
                </a>
            </div>
                        ...
                        <div class="flex items-center gap-4 p-4 bg-gray-50 dark:!bg-bg-card-hover rounded-lg hover:bg-gray-100 dark:!hover:bg-bg-card-hover transition-colors">
                            <div class="w-16 h-24 rounded overflow-hidden bg-gray-200 dark:!bg-gray-700 flex-shrink-0">
                                <?php if($content->poster_path): ?>
                                    ...
                                    ?>
                                    <img src="<?php echo e($posterUrl); ?>" alt="<?php echo e($content->title); ?>" class="w-full h-full object-cover" onerror="this.src='https://via.placeholder.com/185x278?text=No+Image'">
                                <?php else: ?>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-sm text-gray-600 dark:!text-text-secondary mb-2" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                                    ...
                                    <?php if(in_array($content->content_type ?? 'custom', ['tmdb', 'article'])): ?>
                                        <span class="ml-2 px-2 py-0.5 bg-blue-100 text-blue-800 rounded text-xs dark:!bg-blue-900/20 dark:!text-blue-400"><?php echo e($content->content_type === 'article' ? 'Article' : 'TMDB'); ?></span>
                                    <?php endif; ?>
                                </p>
                            ...
                            <div>
                                <a href="<?php echo e(route('admin.contents.edit', $content)); ?>" class="px-3 py-1 bg-accent hover:bg-accent-light text-white rounded text-sm transition-colors" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                                    Edit
                                </a>
                            </div>
                        </div>
            ...
            <?php else: ?>
                <div class="text-center py-12">
                    <p class="text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                        No content yet. <a href="<?php echo e(route('admin.contents.create')); ?>" class="text-accent hover:underline">Create your first content</a>
                    </p>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
                ...
                <div class="space-y-3">
                    <a href="<?php echo e(route('admin.contents.create')); ?>" class="block w-full px-4 py-3 bg-accent hover:bg-accent-light text-white text-center rounded-lg transition-colors font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Add New Content
                    </a>
                    <a href="<?php echo e(route('admin.contents.index')); ?>" class="block w-full px-4 py-3 bg-gray-100 hover:bg-gray-200 text-gray-900 text-center rounded-lg transition-colors dark:!bg-bg-card-hover dark:!text-white dark:!hover:bg-bg-card-hover font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Manage Content
                    </a>
                    <a href="<?php echo e(route('admin.servers.index')); ?>" class="block w-full px-4 py-3 bg-blue-600 hover:bg-blue-700 text-white text-center rounded-lg transition-colors font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Movie Server Management
                    </a>
                    <a href="<?php echo e(route('admin.page-seo.index')); ?>" class="block w-full px-4 py-3 bg-purple-600 hover:bg-purple-700 text-white text-center rounded-lg transition-colors font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Public Pages SEO Management
                    </a>
                    <a href="<?php echo e(route('admin.comments.index')); ?>" class="block w-full px-4 py-3 bg-orange-600 hover:bg-orange-700 text-white text-center rounded-lg transition-colors font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Comments Management
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($tmdbContent)); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">Custom</span>
                        <span class="font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($customContent)); ?></span>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
                ...
                <div class="space-y-3 text-sm">
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <p class="text-gray-900 dark:!text-white font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                                <?php echo e($thisMonthEpisodes); ?> episodes added this month
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <!-- Top Viewed Content -->
    <?php if($topViewedContent->count() > 0): ?>
    <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
            <?php $__currentLoopData = $topViewedContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php
                                $posterUrl = str_starts_with($content->poster_path, 'http') 
                                    ...
                                    : (in_array($content->content_type ?? 'custom', ['tmdb', 'article']) || str_starts_with($content->poster_path, '/')
                                        ...
                                        : asset('storage/' . $content->poster_path));
                            ?>
                            <img src="<?php echo e($posterUrl); ?>" alt="<?php echo e($content->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" onerror="this.src='https://via.placeholder.com/342x513?text=No+Image'">
                        <?php else: ?>
                            <div class="w-full h-full flex items-center justify-center text-gray-400 text-xs">No Image</div>
                        <?php endif; ?>
                        <div class="absolute top-2 right-2 px-2 py-1 bg-black/70 text-white text-xs font-semibold rounded">
                            <?php echo e(number_format($content->views ?? 0)); ?> views
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>