<?php $__env->startSection('title', 'Create Content - Admin'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div id="panel-article" class="tab-panel hidden">
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
            ...
            <div id="article-form-container" class="hidden">
                <form action="<?php echo e(route('admin.contents.article.store')); ?>" method="POST" id="article-content-form">
                    <?php echo csrf_field(); ?>
    ...
    <div id="panel-custom" class="tab-panel hidden">
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
            <form action="<?php echo e(route('admin.contents.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="type" required
                                ...
                                <?php $__currentLoopData = $contentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type); ?>" <?php echo e(old('type') === $type ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="5"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="poster_path" value="<?php echo e(old('poster_path')); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="backdrop_path" value="<?php echo e(old('backdrop_path')); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="date" name="release_date" value="<?php echo e(old('release_date')); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="rating" value="<?php echo e(old('rating')); ?>" min="0" max="10" step="0.1"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                        ...
                        <div>
                            ...
                            <select name="dubbing_language"
                                ...
                                <?php $__currentLoopData = $dubbingLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lang); ?>" <?php echo e(old('dubbing_language') === $lang ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" name="watch_link" value="<?php echo e(old('watch_link')); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" name="download_link" value="<?php echo e(old('download_link')); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
document.getElementById('tmdb-search-form').addEventListener('submit', async function(e) {
    ...
    try {
        const response = await fetch(`<?php echo e(route('admin.contents.tmdb.search')); ?>?q=${encodeURIComponent(query)}&type=${type}`);
        ...
        if (data.results && data.results.length > 0) {
            resultsList.innerHTML = data.results.map(item => {
                const posterUrl = item.poster_path 
                    ? `<?php echo e(config('services.tmdb.image_base_url')); ?>/w185${item.poster_path}`
                ...
                return `
                    <div class="bg-gray-50 dark:!bg-bg-card-hover rounded-lg border border-gray-200 dark:!border-border-secondary p-4">
                        ...
                        <form action="<?php echo e(route('admin.contents.tmdb.import')); ?>" method="POST" class="inline">
                            <?php echo csrf_field(); ?>
        ...
        if (data.results && data.results.length > 0) {
            resultsList.innerHTML = data.results.map(item => {
                ...
                const backdropUrl = item.backdrop_path 
                    ? `<?php echo e(config('services.tmdb.image_base_url')); ?>/w780${item.backdrop_path}`
...
function selectArticleContent(tmdbId, type, item) {
    ...
    const posterUrl = item.poster_path 
        ...
        : 'https://via.placeholder.com/185x278?text=No+Image';
    const backdropUrl = item.backdrop_path 
        ? `<?php echo e(config('services.tmdb.image_base_url')); ?>/w1280${item.backdrop_path}`
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox\resources\views/admin/contents/create.blade.php ENDPATH**/ ?>