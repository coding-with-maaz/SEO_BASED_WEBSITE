<?php $__env->startSection('title', 'Edit Content - Admin'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6 flex items-center justify-between">
        <div>
            <div class="flex items-center gap-4 mb-2">
                ...
                <a href="<?php echo e(route('admin.contents.index')); ?>" class="text-gray-600 hover:text-accent dark:!text-text-secondary dark:!hover:text-accent transition-colors" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                    All Content
                </a>
            </div>
        ...
        <div class="flex gap-3">
            <a href="<?php echo e(route('admin.contents.index')); ?>" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg transition-colors dark:!bg-bg-card dark:!text-white dark:!hover:bg-bg-card-hover" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                Back to List
            </a>
            <?php if(in_array($content->type, ['tv_show', 'web_series', 'anime', 'reality_show', 'talk_show'])): ?>
                <a href="<?php echo e(route('admin.episodes.index', $content)); ?>" class="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                    Manage Episodes
                </a>
            <?php endif; ?>
        </div>
    ...
    <div id="panel-details" class="tab-panel">
        <div class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
            <form action="<?php echo e(route('admin.contents.update', $content)); ?>" method="POST">
                <?php echo csrf_field(); ?>
                        ...
                        <div>
                            ...
                            <select name="type" required
                                ...
                                <?php $__currentLoopData = $contentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($type); ?>" <?php echo e(old('type', $content->type) === $type ? 'selected' : ''); ?>><?php echo e($label); ?></option>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="5"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"><?php echo e(old('description', $content->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="article_content" rows="10"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white"><?php echo e(old('article_content', $content->article_content)); ?></textarea>
                            ...
                            <?php $__errorArgs = ['article_content'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="poster_path" value="<?php echo e(old('poster_path', $content->poster_path)); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                            <?php if($content->poster_path): ?>
                                ...
                                ?>
                                <img src="<?php echo e($posterUrl); ?>" alt="Poster" class="mt-2 w-32 h-auto rounded">
                            <?php endif; ?>
                            <?php $__errorArgs = ['poster_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="backdrop_path" value="<?php echo e(old('backdrop_path', $content->backdrop_path)); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                            <?php if($content->backdrop_path): ?>
                                <?php
                                    $contentType = $content->content_type ?? 'custom';
                                    $backdropUrl = str_starts_with($content->backdrop_path, 'http') 
                                        ...
                                        : (in_array($contentType, ['tmdb', 'article']) || str_starts_with($content->backdrop_path, '/')
                                            ...
                                            : $content->backdrop_path);
                                ?>
                                <img src="<?php echo e($backdropUrl); ?>" alt="Backdrop" class="mt-2 w-full max-w-md h-auto rounded">
                            <?php endif; ?>
                            <?php $__errorArgs = ['backdrop_path'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="date" name="release_date" value="<?php echo e(old('release_date', $content->release_date?->format('Y-m-d'))); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="rating" value="<?php echo e(old('rating', $content->rating)); ?>" min="0" max="10" step="0.1"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="status" required
                                ...
                                <option value="upcoming" <?php echo e(old('status', $content->status) === 'upcoming' ? 'selected' : ''); ?>>Upcoming</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="series_status"
                                ...
                                <?php $__currentLoopData = \App\Models\Content::getSeriesStatuses(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status); ?>" <?php echo e(old('series_status', $content->series_status) === $status ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['series_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="dubbing_language"
                                ...
                                <?php $__currentLoopData = $dubbingLanguages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($lang); ?>" <?php echo e(old('dubbing_language', $content->dubbing_language) === $lang ? 'selected' : ''); ?>><?php echo e($label); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['dubbing_language'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" name="watch_link" value="<?php echo e(old('watch_link', $content->watch_link)); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
                            <?php $__errorArgs = ['watch_link'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="url" name="download_link" value="<?php echo e(old('download_link', $content->download_link)); ?>" placeholder="https://..."
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="flex items-center gap-2">
                                <input type="checkbox" name="is_featured" value="1" <?php echo e(old('is_featured', $content->is_featured) ? 'checked' : ''); ?>
                        ...
                        <input type="hidden" name="content_type" value="<?php echo e($content->content_type); ?>">
                        <?php if($content->tmdb_id): ?>
                            <input type="hidden" name="tmdb_id" value="<?php echo e($content->tmdb_id); ?>">
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="mt-6 flex gap-4">
                    ...
                    <a href="<?php echo e(route('admin.contents.index')); ?>" class="px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-900 rounded-lg transition-colors dark:!bg-bg-card dark:!text-white dark:!hover:bg-bg-card-hover" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Cancel
                    </a>
                </div>
            </form>
                        ...
                        <div class="border border-gray-200 dark:!border-border-secondary rounded-lg p-4 bg-gray-50 dark:!bg-bg-card-hover">
                            <div class="flex items-start justify-between">
                                <div class="flex-1">
                                    <div class="flex items-center gap-3 mb-2">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                                            <?php echo e($server['name'] ?? 'Server ' . ($index + 1)); ?>

                                        </h3>
                                        <?php if(!empty($server['quality'])): ?>
                                            <span class="px-2 py-1 text-xs font-semibold bg-blue-100 text-blue-800 rounded dark:!bg-blue-900/20 dark:!text-blue-400">
                                                <?php echo e($server['quality']); ?>

                                            </span>
                                        <?php endif; ?>
                                        <?php if(isset($server['active']) && !$server['active']): ?>
                                    ...
                                    <?php if(!empty($server['url'])): ?>
                                        <p class="text-sm text-gray-600 dark:!text-text-secondary mb-1" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                                            ...
                                            <a href="<?php echo e($server['url']); ?>" target="_blank" class="text-accent hover:underline break-all">
                                                <?php echo e(Str::limit($server['url'], 60)); ?>

                                            </a>
                                        </p>
                                    <?php endif; ?>
                                    <?php if(isset($server['download_link'])): ?>
                                        <p class="text-sm text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                                            ...
                                            <a href="<?php echo e($server['download_link']); ?>" target="_blank" class="text-accent hover:underline break-all">
                                                <?php echo e(Str::limit($server['download_link'], 60)); ?>
                                ...
                                <div class="flex gap-2 ml-4">
                                    <button onclick="showEditServerModal(<?php echo e(json_encode($server)); ?>, <?php echo e($index); ?>)" 
                                    ...
                                    <form action="<?php echo e(route('admin.contents.servers.destroy', $content)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" name="server_id" value="<?php echo e($server['id'] ?? ''); ?>">
...
<div id="add-server-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white dark:!bg-bg-card rounded-lg max-w-md w-full p-6">
        ...
        <form action="<?php echo e(route('admin.contents.servers.store', $content)); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <div class="space-y-4">
                <div>
...
<div id="edit-server-modal" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center p-4">
    <div class="bg-white dark:!bg-bg-card rounded-lg max-w-md w-full p-6">
        ...
        <form id="edit-server-form" action="<?php echo e(route('admin.contents.servers.update', $content)); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox\resources\views/admin/contents/edit.blade.php ENDPATH**/ ?>