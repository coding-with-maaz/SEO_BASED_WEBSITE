...
<body>
    <nav class="sticky top-0 z-50 bg-white backdrop-blur-lg shadow-lg border-b border-gray-200 dark-mode:bg-bg-primary/95 dark-mode:border-border-primary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <ul class="hidden md:flex items-center gap-6 lg:gap-8">
                    <li><a href="{{ route('home') }}" class="text-gray-900 hover:text-accent transition-colors font-semibold dark-mode:text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Home</a></li>
                    <li><a href="{{ route('movies.index') }}" class="text-gray-900 hover:text-accent transition-colors font-semibold dark-mode:text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Movies</a></li>
                    <li><a href="{{ route('tv-shows.index') }}" class="text-gray-900 hover:text-accent transition-colors font-semibold dark-mode:text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">TV Shows</a></li>
                    <li><a href="#" class="text-gray-900 hover:text-accent transition-colors font-semibold dark-mode:text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Upcoming</a></li>
                    <li><a href="#" class="text-gray-900 hover:text-accent transition-colors font-semibold dark-mode:text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">About Us</a></li>
                </ul>
                <form action="{{ route('search') }}" method="GET" class="hidden lg:flex items-center gap-2">
                    <input type="text" name="q" 
                           class="px-4 py-2 w-64 rounded-full bg-gray-100 border border-gray-300 text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all dark-mode:bg-bg-card dark-mode:border-border-primary dark-mode:text-white dark-mode:placeholder-text-muted" 
                ...
                <div class="flex items-center gap-4">
                    <!-- Theme Toggle -->
                    <button id="themeToggle" class="p-2 rounded-lg bg-gray-100 hover:bg-gray-200 border border-gray-300 transition-all dark-mode:bg-bg-card dark-mode:border-border-primary dark-mode:hover:bg-bg-card-hover" title="Toggle Theme">
                        <svg id="sunIcon" class="w-5 h-5 text-gray-900 dark-mode:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
                        </svg>
                        <svg id="moonIcon" class="w-5 h-5 text-white hidden dark-mode:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path>
                        </svg>
                    </button>
                    <button class="md:hidden text-gray-900 hover:text-accent dark-mode:text-white">
    ...
    <!-- Footer -->
    <footer class="bg-gray-50 border-t border-gray-200 mt-12 dark-mode:bg-bg-card dark-mode:border-border-primary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center space-y-4">
                <div class="flex justify-center items-center gap-4 mb-4">
                    <a href="#" class="text-gray-600 hover:text-accent transition-colors dark-mode:text-text-secondary">
                ...
                <p class="text-gray-600 text-sm dark-mode:text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
