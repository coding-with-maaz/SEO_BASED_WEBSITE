...
<body>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="flex items-center gap-4">
                    <!-- Theme Toggle -->
                    <button id="themeToggle" class="p-2 rounded-lg bg-bg-card hover:bg-bg-card-hover border border-border-primary transition-all dark-mode:bg-bg-card dark-mode:border-border-primary" title="Toggle Theme">
                        <svg id="sunIcon" class="w-5 h-5 text-text-primary dark-mode:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
                        </svg>
                        <svg id="moonIcon" class="w-5 h-5 text-text-primary hidden dark-mode:block" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path>
                        </svg>
                    </button>
                    <button class="md:hidden text-text-primary hover:text-accent dark-mode:text-text-primary">
    ...
    <!-- Footer -->
    <footer class="bg-bg-card border-t border-border-primary mt-12 dark-mode:bg-bg-card dark-mode:border-border-primary">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center space-y-4">
                <div class="flex justify-center items-center gap-4 mb-4">
                    <a href="#" class="text-text-secondary hover:text-accent transition-colors dark-mode:text-text-secondary">
