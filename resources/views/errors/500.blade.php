...
<div class="min-h-[60vh] flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
    <div class="max-w-2xl mx-auto text-center">
        <!-- Error Code -->
        <div class="mb-8">
            <h1 class="text-9xl md:text-[12rem] font-bold text-red-600 dark:!text-red-500 leading-none" style="font-family: 'Poppins', sans-serif; font-weight: 800;">
                500
            </h1>
        </div>
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:!border-border-primary">
            <p class="text-sm text-gray-500 dark:!text-text-tertiary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                If the problem persists, please <a href="{{ route('about') }}" class="text-accent hover:text-accent-light underline">contact us</a> or try again later.
            </p>
        </div>
    </div>
</div>
