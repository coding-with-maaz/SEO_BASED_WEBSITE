    ...
    <div class="max-w-2xl mx-auto text-center">
        ...
        <div class="mt-12 pt-8 border-t border-gray-200 dark:!border-border-primary">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="{{ route('tv-shows.index') }}" class="text-accent hover:text-accent-light font-semibold text-sm" style="font-family: 'Poppins', sans-serif; font-weight: 600;">TV Shows</a>
                <a href="{{ route('cast.index') }}" class="text-accent hover:text-accent-light font-semibold text-sm" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Cast</a>
                <a href="{{ route('upcoming') }}" class="text-accent hover:text-accent-light font-semibold text-sm" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Upcoming</a>
                <a href="{{ route('completed') }}" class="text-accent hover:text-accent-light font-semibold text-sm" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Completed</a>
            </div>
        </div>
    </div>
</div>
